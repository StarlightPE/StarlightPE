...
const CommandSender = starlightpe("command/CommandSender");
const InvalidParameterError = starlightpe("error/InvalidParameterError");

class CommandMap {
    initVars(){
        this.StarlightPEServer = {};
    ...
    dispatchCommand(sender, commandLine) {
        ...
        if(this.commands.has(cmd)){
            ...
            sender.sendMessage("§cUnknown Command: §7Try §e/help §7for a list of commands and their perimeters");
        }
    }
}
